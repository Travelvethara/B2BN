							...
							<div class="form-group m-form__group row align-items-center">
								...
								<div class="col-md-4">
									<div class="m-input-icon m-input-icon--left">
										<input type="text" class="form-control m-input" placeholder="Serach by name ,email etc" id="generalSearch" value="">
					...
					<tbody>
						...
						<td>
							...
							if($Premissions['type'] == 'UserInfo') {
								if($Premissions['premission'][0]->agency_edit == 1){
									
									?>
									
									<a href="{{route('agency')}}?id={{Crypt::encrypt(base64_encode($details->id))}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" ><i class="fas fa-edit"></i></a                                   ><?php } } ?>
									...
									<?php 
									if($Premissions['type'] == 'UserInfo') {
										if($Premissions['premission'][0]->agency_remove == 1){
       ...
       if (r === false) {
		...
		function append_data(d) {
			...
			$.map( d, function( a ) {
				...
				eyeicon =  '<a href="<?php echo route('agency.viewagency') ?>?id='+a.id+'" ><i class="fas fa-eye" data-id="1"></i></a>';

				
				if(usertype == 'SuperAdmin') {	
					editicon = '<a href="<?php echo route('agency'); ?>?id='+a.id+'" ><i class="fas fa-edit"></i></a>';	
				...
				if(usertype == 'UserInfo') {	
					...
					if(editpermission == 1) { editicon = '<a href="<?php echo route('agency'); ?>?id='+a.id+'" ><i class="fas fa-edit"></i></a>';	}
