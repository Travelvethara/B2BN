					...
					<div class="tab-content">
						...
						<div class="tab-pane agencyinformation <?php echo $activecon2; ?>" <?php if(isset($_GET['id']) && !empty($_GET['id'])){?> id="m_tabs_6_3" <?php }?> role="tabpanel">
							...
							<div class="m-portlet-alterr m-portlet m-portlet-padding agency-info-tab">
								<form action="{{route('signupagencyupdate')}}" class="m-form m-form--fit" method="post" id="signformsubmit">
                                    ...
                                    <div class="form-group m-form__group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control "  maxlength="30" name="mphone" id="phone"    value="" >
                                    ...
                                    <div class="form-group m-form__group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" maxlength="30" name="mobile" id="mobile12"   <?php if (isset($agency->amobile) && !empty($agency->amobile)){?> value="{{ $agency->amobile }}" <?php }else{ ?>value="{{old('amobile')}}"<?php } ?>>
											<span class="error-message mobilea12-check" style="display:none"> 
												The field is required.
											</span>
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-6">
											<input type="text" tabindex="-1" name="userid" class="form-control m-input" readonly  placeholder="AUTO" <?php if (isset($agency->userid) && !empty($agency->userid)){?> value="{{ $agency->userid }}" <?php }else{ ?>value="{{old('userid')}}"<?php } ?>>
											<!--<span class="m-form__help">Please enter your full name</span>-->
										</div>
									</div>
										...
										<div class="m-form__actions m-form__actions">
											<div class="row">
                                                ...
                                                <span class="error-message verfycontenterror" style="display:none"> 
                                                        Please fill your Agency details
							...
							<div class="m-portlet m-portlet-padding agency-info-tab agency-info-tab-two m-form m-portlet-alterr">
								<form action="{{ route($route1) }}" method="POST" id="agency_info">
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control verfycontent" maxlength="30"  name="aname" id="aname"  <?php if (isset($agency->aname) && !empty($agency->aname)){?> value="{{ $agency->aname }}" <?php }else{ ?>value="{{old('aname')}}"<?php } ?> maxlength="30"/>
											<!--<span class="m-form__help">Please enter your full name</span>-->
									...
									<div class="form-group m-form__group row">
										<label class="col-lg-3 col-form-label">Email<span class="requiredcls" aria-required="true"> * </span></label>
										<div class="col-lg-6">
											<input type="email" class="form-control verfycontent" maxlength="30" name="aemail" id="aemail" aria-describedby="emailHelp"  <?php if (isset($agency->aemail) && !empty($agency->aemail)){?> value="{{ $agency->aemail }}" <?php }else{ ?>value="{{old('aemail')}}"<?php } ?>>
											<!--<span class="m-form__help">Please enter your Email name</span>-->
                                    ...
                                    <div class="form-group m-form__group row">
										<label class="col-lg-3 col-form-label">Confirm Email<span class="requiredcls" aria-required="true"> * </span></label>
										<div class="col-lg-6">
											<input type="email" name="conformemail1" id="conformemail1" class="form-control verfycontent" maxlength="30"  aria-describedby="emailHelp" <?php if (isset($agency->email) && !empty($agency->email)){?> value="{{ $agency->email }}" <?php }else{ ?>value="{{old('email')}}"<?php } ?>>
											<!--<span class="m-form__help">Please enter your Email name</span>-->
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-6">
                                        <textarea class="form-control m-input verfycontent"  name="address1"  id="address1" style="height: 90px;"><?php if (isset($agency->address1) && !empty($agency->address1)){ echo $agency->address1; } ?></textarea>
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-6">
											<select name="country" class="form-control verfycontent" id="country">
							 ...
							 <div class="form-group m-form__group row cityallo" <?php if(isset($agency) && !empty($agency)) { if($agency->country == 'Pakistan') { ?> style="display:none"; <?php } } ?>>
						                      <label class="col-lg-3 col-form-label">City<span class="requiredcls" aria-required="true"> * </span></label>
						                       <div class="col-lg-6">
							                 <input type="text" class="form-control m-input cityall verfycontent"   placeholder="" maxlength="30" <?php if(isset($agency) && !empty($agency)) { if($agency->country != 'Pakistan') { ?> name="city" id="city" <?php } }else{  ?> name="city" id="city" <?php } ?>   <?php if (isset($agency->city) && !empty($agency->city)){?> value="{{ $agency->city }}" <?php }else{ ?>value="{{old('city')}}"<?php } ?>>
                                 ...
                                 <span class="error-message"> 
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control m-input verfycontent" maxlength="30"  name="zip" id="zip" placeholder=""  <?php if (isset($agency->pcode) && !empty($agency->pcode)){?> value="{{ $agency->pcode }}" <?php }else{ ?>value="{{old('zip')}}"<?php } ?>>
									...
									<div class="form-group m-form__group row">
										<label class="col-lg-3 col-form-label">Phone<span class="requiredcls" aria-required="true">  </span></label>
										<div class="col-lg-6">
											<input type="text" class="form-control "  maxlength="30" name="aphone" id=""    <?php if (isset($agency->aphone) && !empty($agency->aphone)){?> value="{{ $agency->aphone }}" <?php }else{ ?>value="{{old('aphone')}}"<?php } ?> >
									...
									<div class="form-group m-form__group row">
										<label class="col-lg-3 col-form-label" maxlength="30">Register / IATA No <span class="requiredcls" aria-required="true"> * </span></label>
										<div class="col-lg-6">
											<input type="text" class="form-control m-input required verfycontent" name="register_number"  id="register_number"  placeholder="" <?php if (isset($agency->rnumber) && !empty($agency->rnumber)){?> value="{{ $agency->rnumber }}" <?php }else{ ?> value="{{old('register_number')}}"<?php } ?> />
...
var signupagencymanager = "{{ URL::to('signupagencymanager')}}";
var agencyInsertAjaxValidate = "{{ URL::to('agencyInsertAjaxValidate')}}";

	$(document).ready(function (){

		$(document).on('click', '.managerdetailsactive', function(){
			
			$('.managerdetailsactive').addClass('active');
			$('.managerdetailsactive').addClass('show');
		...
		$(document).on('click', '.agencyinfo', function(){
			...
			$('.managerdetailsactive').removeClass('active');
			$('.managerdetailsactive').removeClass('show');
		...
		$(document).on('change', '#country', function(){
			   ...
			   if(country == 'Pakistan'){
				   ...
				   $(".cityp").addClass('verfycontent');
				   $(".cityall").removeClass('verfycontent');
				   ...
				   $(".cityp").removeClass('verfycontent');
				   $(".cityall").addClass('verfycontent');
...
/*	if($('#phone').val() == ''){
	...
	//alert(name);
	$('#mobile12').focus();
	$('.mobilea12-check').show();
	error=1;
}else{
	$('.mobilea12-check').hide();
}
        ...
        success: function(data){
			...
			if(data == 'ok'){
				...
				console.log(data);
				  ...
				  $.ajax({
						type:"POST",
						url:signupagencymanager,
						data:$('#agency_info').serialize(),
						success: function(data){
							 console.log(data);
...
console.log('fkgjhkfjhkfjhjfghjfgjhgjhkjfg');
