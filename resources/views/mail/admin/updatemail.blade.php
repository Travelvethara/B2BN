                  ...
                  <tbody>
                    <tr>
                      <td align="left" style="padding:20px 20px 20px 20px">
                        <div style="font-family:Arial Black,Arial,Helvetica;font-size:18px;line-height:30px;font-weight:700">Hi Admin ,</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="padding:0px 20px 20px 20px">
                        <div style="font-family:Arial,Helvetica;font-size:15px;line-height:22px">This {{$username}}({{$usertype}}) updated their profile. Kindly check it</div>
                      </td>
                    </tr>                    <tr>
