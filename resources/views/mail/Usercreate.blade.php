                  ...
                  <tbody>
                    <tr>
                      <td align="left" style="padding:20px 20px 20px 20px">
                        <div style="font-family:Arial Black,Arial,Helvetica;font-size:18px;line-height:30px;font-weight:700">Hi {{$name}}.</div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td align="left" style="padding:0px 20px 20px 20px">
                        <div style="font-family:Arial,Helvetica;font-size:15px;line-height:22px">The User created by {{$role_name}}</div>
                      </td>
                      </tr>
                      <tr>
                      <td align="left" style="padding:0px 20px 20px 20px">
                        <div style="font-family:Arial,Helvetica;font-size:15px;line-height:22px">Login : {{$email}}</div>
                      </td>
                      </tr>
                      <tr>
                      <td align="left" style="padding:0px 20px 20px 20px">
                        <div style="font-family:Arial,Helvetica;font-size:15px;line-height:22px">Password: {{$password}}</div>
                      </td>
                     ...
                     <tr>
                      <td align="left" style="padding:0px 20px 20px 20px">
                        <div style="font-family:Arial,Helvetica;font-size:15px;line-height:22px">The request will be sent to administrator after clicking below button.</div>
                      </td>
                    </tr>             
                     <tr>
                      <td><a href="{{route('verficationemail')}}?id=<?php echo $id; ?>&us=<?php echo $us; ?>" style="padding-left: 20px;margin-bottom: 20px;display: block;"><button id="" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary loginhome">
											Click
										</button></a></td>
                    </tr>
