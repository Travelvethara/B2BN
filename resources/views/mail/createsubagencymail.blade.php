              ...
              <td style="padding:0px;border-radius:5px 5px 5px 5px;background-color:#ffffff;" align="center">  
                <table width="100%" style="border-spacing:0">
                  <tbody>
                    ...
                    <tr>
                      <td align="left" style="padding:0px 20px 20px 20px">
                        <div style="font-family:Arial,Helvetica;font-size:15px;line-height:22px">Thank you for your register, your request will be sent  to site administrator for aproval. You will then  receive an email with further instructions</div>
                      </td>
                    </tr>                    <tr>
